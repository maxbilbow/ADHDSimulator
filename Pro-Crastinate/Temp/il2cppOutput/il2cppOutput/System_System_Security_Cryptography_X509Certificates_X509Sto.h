...
struct  X509Store_t1141  : public Object_t
{
	...
	X509Certificate2Collection_t1134 * ___list_2;
	...
	X509Store_t944 * ___store_4;
};
struct X509Store_t1141_StaticFields{
	...
	Dictionary_2_t598 * ___U3CU3Ef__switchU24mapF_5;
};
