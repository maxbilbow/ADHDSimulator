...
struct  X509Store_t1152  : public Object_t
{
	...
	X509Certificate2Collection_t1146 * ___list_2;
	...
	X509Store_t956 * ___store_4;
};
struct X509Store_t1152_StaticFields{
	...
	Dictionary_2_t606 * ___U3CU3Ef__switchU24mapF_5;
};
