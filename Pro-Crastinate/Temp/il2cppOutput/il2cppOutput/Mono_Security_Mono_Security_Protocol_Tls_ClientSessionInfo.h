...
struct  ClientSessionInfo_t971  : public Object_t
{
	...
	ByteU5BU5D_t616* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t616* ___masterSecret_5;
};
struct ClientSessionInfo_t971_StaticFields{
