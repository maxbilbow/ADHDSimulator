...
struct  ClientSessionInfo_t983  : public Object_t
{
	...
	ByteU5BU5D_t625* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t625* ___masterSecret_5;
};
struct ClientSessionInfo_t983_StaticFields{
