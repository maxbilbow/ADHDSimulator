...
struct  SimpleMouseRotator_t116  : public MonoBehaviour_t33
{
	// UnityEngine.Vector2 UnityStandardAssets.Utility.SimpleMouseRotator::rotationRange
	Vector2_t42  ___rotationRange_2;
