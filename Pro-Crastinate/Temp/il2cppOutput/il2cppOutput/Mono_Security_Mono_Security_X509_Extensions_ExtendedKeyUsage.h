...
struct  ExtendedKeyUsageExtension_t961  : public X509Extension_t955
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t920 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t961_StaticFields{
	...
	Dictionary_2_t606 * ___U3CU3Ef__switchU24map14_4;
};
