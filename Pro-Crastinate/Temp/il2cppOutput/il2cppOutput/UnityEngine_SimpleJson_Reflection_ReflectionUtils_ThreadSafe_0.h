...
struct  ThreadSafeDictionary_2_t852  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t851 * ____valueFactory_1;
	...
	Dictionary_2_t2471 * ____dictionary_2;
};
